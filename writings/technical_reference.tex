...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Wed, Feb 27, 2019 - 3:15:32 PM
\begin{table}[!htbp] \centering 
...
\textbf{Census tract sampling strata} After selecting census tracts from the census tract sampling stratum, we contacted the urban planning departments of each suburban county with maps of the selected census tracts and guidelines for site selection. Each of these counties responded with a set of physical count locations. For more on this, see Section~\ref{sec:stakeholder-engagement}. \\
